...
class TestHentai(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with open("Between Friends.json") as fh:
    ...
    def test_url(self):
        self.assertEqual(
            self.test_reference["url"],
            self.test_response.url, msg=str(self.test_response),
        )

    def test_name(self):
        self.assertEqual(
            self.test_reference["name"], self.test_response.name, msg=str(
            self.test_response,
            ),
        )
